...
Internal maintenance renewal tracker for Careware's Renewal & Accounts teams — manages customer renewal schedules, auto-triggers email reminders at 2-month and 1-month intervals, and flags records as billed when complete.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "34409240+Karengoh123@users.noreply.github.com"
  git config user.name "Karengoh123"
  ```
